/* =====================================================
   Expreso – Global Interaction Layer
...
(function () {
  ...
  if (!sessionStorage.getItem('wa-cta-dismissed')) {
    ...
    banner.innerHTML = `
      ...
      <span class="wa-cta-text">Need help choosing? Chat with Expreso →</span>
    ...
    <div id="chat-panel" role="dialog" aria-label="Chat assistant">
      <div class="chat-header">
        ...
        <div class="chat-header-info">
          <div class="chat-header-name">Expreso Assistant</div>
      ...
      try {
        const res = await fetch('https://api.anthropic.com/v1/messages', {
          ...
          body: JSON.stringify({
            ...
            max_tokens: 256,
            system: `You are a helpful sales assistant for Expreso, an electric vehicle dealer in Howrah, India. Keep replies short (2-3 sentences max), friendly, and in the same language the customer uses (English, Bengali, or Hindi). Products: e-rickshaws (₹88K–₹1.35L), e-scooters (₹52K–₹92K), spare parts. COD available under ₹5000. WhatsApp: +91 91639 68140.`,
  ...
  function toggleChat() {
    ...
    if (chatOpen && messages.children.length === 0) {
      ...
      setTimeout(() => addMessage('👋 नमस्কার! Hi! আমি Expreso-এর AI assistant। How can I help you today?', 'bot'), 300);
